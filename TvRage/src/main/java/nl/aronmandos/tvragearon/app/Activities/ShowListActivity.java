 ...
 * lead to a {@link nl.aronmandos.tvragearon.app.Activities.ShowDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link nl.aronmandos.tvragearon.app.Fragments.ShowListFragment} and the item details
 * (if present) is a {@link nl.aronmandos.tvragearon.app.Fragments.ShowDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link nl.aronmandos.tvragearon.app.Fragments.ShowListFragment.Callbacks} interface
...
public class ShowListActivity extends FragmentActivity
    ...
    /**
     * Callback method from {@link ShowListFragment.Callbacks}
